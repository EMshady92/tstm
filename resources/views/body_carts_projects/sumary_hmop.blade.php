...
<div class="w-full mx-2">
    <div class="w-full my-2">
        <div class="mt-2 flex gap-x-3 w-full justify-center">
            ...
            <div class="text-white  font-bold text-xl font-roboto gap-x-2 flex place-items-center"><img class="w-10 h-10" title="Livewire" src="{{asset('images/livewire.png')}}"><b>Livewire</b></div>
    ...
    <div class="w-full">
        <h1 class="font-bold text-white text-2xl mx-2 my-2 indent-px">
            {{__('index.acerca_de')}} HMOP
        </h1>
        <hr class="border-[#6b7280] w-[98.5%]">
        <p class="font-bold text-white text-xl mx-2 my-2 indent-px">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Pariatur reiciendis quos facere sapiente quis dolore hic doloribus, ratione assumenda, beatae nesciunt velit veritatis quo asperiores cupiditate nulla amet deserunt. Sed.
        </p>
    </div>

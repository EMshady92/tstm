            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edición tipos de listas</li>
                    </ol>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div>
                            ...
                            <form action="{{url('/listas', [$listas->id])}}" id="formulario" method="post" class="form-horizontal parsley-examples" enctype="multipart/form-data" accept-charset="UTF-8" >
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="tipo" id="tipo" required
                                    data-toggle="">
                                    @if ($listas->tipo == '1')
                                    <option selected value="1">PROVEEDORES</option>
                                    <option value="2">MATERIALES</option>
                                    @else
                                    <option value="1">PROVEEDORES</option>
                                    <option  selected value="2">MATERIALES</option>
                                    @endif

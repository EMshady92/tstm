            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Catalogo listas Ventas</li>
                    </ol>
                </div>
                <h4 class="page-title">Catálogo de listas Ventas</h4>
                <hr>
                <a href="/listas_ventas/create" class="button-list">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <a  href="{{ route('listas_ventas.edit',$lista->id) }}"
                            ...
                            <a class="btn waves-effect waves-light btn-warning" onclick=inactivar('{{$lista->id}}','listas_ventas');

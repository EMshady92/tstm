            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edición tipos de listas Cal-Sal</li>
                    </ol>
                </div>
                <h4 class="page-title">Editar lista Cal-Sal</h4>
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="tipo" id="tipo" required
                                    data-toggle="">
                                    @if ($listas->tipo == '3')
                                    <option selected value="3">PROVEEDORES</option>
                                    <option value="4">MATERIALES</option>
                                    @else
                                    <option value="3">PROVEEDORES</option>
                                    <option  selected value="4">MATERIALES</option>
                                    @endif

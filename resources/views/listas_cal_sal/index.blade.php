            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="/listas_cal_sal">Listas Cal-Sal</a></li>
                        <li class="breadcrumb-item active">Catalogo listas Cal-Sal</li>
                    </ol>
                </div>
                <h4 class="page-title">Catálogo de listas Cal-Sal</h4>
                <hr>
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <a  href="{{ route('listas_cal_sal.edit',$lista->id) }}"
                            ...
                            <td>   <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token">
                                <a class="btn waves-effect waves-light btn-warning" onclick=inactivar('{{$lista->id}}','listas_cal_sal');

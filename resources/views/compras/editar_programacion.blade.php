...
@include('compras.modal_editar_venta')
<!-- Start Content-->
                ...
                <div class="col-md-6  input-group" style="padding:2em; color: black;">
                    ...
                    <div class="form-group col-md-12">
                            ...
                            <option value="VENTA">VENTA</option>
                                ...
                                <div id="display_compra_edicion" style="display: none;">
                            ...
                            <div id="display_venta_edicion" style="display: block;">
                                    <div style="display: block; -webkit-box-shadow: 2px 2px 5px #999; -moz-box-shadow: 2px 2px 5px #999;" id="formulario_manual_venta"  name="formulario_manual_venta" class="form-row widget p-md">

                                          <div class="form-group col-md-6">
                                          <label for="orden_venta">ORDEN</label>
                                          <input type="text"  name="orden_venta" parsley-trigger="change" required class="form-control" id="orden_venta">
                                        </div>


                                        <div class="form-group col-md-6">
                                          <label for="fecha_venta">FECHA</label>
                                          <input type="date"  name="fecha_venta" onchange="traer_ventas_dates(this.value)" parsley-trigger="change" required class="form-control" id="fecha_venta">
                                        </div>

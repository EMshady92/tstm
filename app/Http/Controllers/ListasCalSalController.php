...
class ListasCalSalController extends Controller
{
    ...
    public function index()
    {
       ...
       return view('listas_cal_sal.index', ['listas' => $listas]);
    }
    ...
    {
        return view('listas_cal_sal.create');
    }
    ...
    public function store(Request $request)
    {
       ...
       // DB::select('CALL InsertarMovimiento ("'.$user->id.'","create","tipos_promociones","'.$promocion->id.'","'.base64_encode(json_encode($promocion)).'"," ","El usuario ha creado un nuevo tipo de promoción")');
        ...
        return Redirect::to('/listas_cal_sal');
    }
    ...
    public function edit($id)
    {
        ...
        return view("listas_cal_sal.edit",["listas"=>$listas]);
    }
